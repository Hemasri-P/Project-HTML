...
- Provides security
- We can Acheive Encapsulation by using class , u need to merger varibales and methods into a single class, so that only that clas members access the value.
