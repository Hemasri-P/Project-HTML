...
- 4. Docker Commands : all commands begin with " Doker start " , " dpcker stop , push , pull , run "
...
- Blazor is developed by C# lnguage
...
- in SSR- the webserver runs it and converts to html and again send it to browser for results
...
- Routing : giving navigations to anither page
